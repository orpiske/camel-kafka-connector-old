 ...
 * messages
 */
public class CamelSinkAMQPITCase extends CamelSinkJMSITCase {
    @Override
    protected ConnectorPropertyFactory getConnectorPropertyFactory() {
        return new CamelJMSPropertyFactory(1,
                TestCommon.DEFAULT_TEST_TOPIC, TestCommon.DEFAULT_JMS_QUEUE, artemis.getAMQPEndpoint(),
                org.apache.qpid.jms.JmsConnectionFactory.class.getName());
    }
